...
def create_game_poster(
    ...
    **kwargs: Any
    ...
    Parameters:
        ...
        watermark_font: Gaming font family or TTF path (default: 'Anton').
        watermark_size: Optional font size in px.
        watermark_color: Watermark text fill color (default: '#ffffff').
        watermark_stroke_color: Watermark stroke outline color (default: '#0f172a').
        watermark_stroke_width: Watermark stroke width in px (default: 3).
        watermark_x: Optional normalized [0.0, 1.0] or pixel horizontal center position.
        watermark_y: Optional normalized [0.0, 1.0] or pixel vertical center position.
        zoom: Fit zoom multiplier (default: 1.0).
        pan_x: Horizontal poster pan offset in canvas pixels (default: 0.0).
        pan_y: Vertical poster pan offset in canvas pixels (default: 0.0).
